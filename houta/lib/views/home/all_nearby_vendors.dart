...
import 'package:houta/hooks/fetch_all_vendors.dart';
import 'package:houta/models/vendors_model.dart';
import 'package:houta/views/home/widgets/vendor_tile.dart';

class AllNearbyVendors extends HookWidget {
  const AllNearbyVendors({super.key});

  @override
  Widget build(BuildContext context) {
    final hookResults = useFetchAllVendor("41007428");
