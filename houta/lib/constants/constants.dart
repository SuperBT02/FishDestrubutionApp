...
String googleApiKey = 'AIzaSyB4PYeQy9Eb0CqwI-9SWqjTea91dM-iLKY';
...
final List<String> verificationReasons = [
  'Real-time Update: Get instant notification about your order status.',
  'Direct Communication: A verified number ensures seamless communication',
  'Enhaced Security: Pretect your account and confirm orders securely',
  'Effortless Rescheling : Easily address issues with a quick call.',
